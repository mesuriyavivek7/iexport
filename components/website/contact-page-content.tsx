...
export function ContactPageContent() {
  const { data, isPending } = useContactUs()
        ...
        <section className="relative z-40 mx-auto max-w-6xl px-4 sm:px-6">
          <div className="flex flex-col items-center gap-3 sm:gap-4">
            ...
            <p className="text-center text-sm sm:text-base text-white leading-6 sm:leading-7 max-w-3xl">
              We&apos;d love to discuss your sourcing, exporting, or bulk supply requirements.
              Fill out the form below or reach out to us directly for reliable and timely
            ...
            <div className="flex flex-col gap-6 lg:gap-4">
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-3 sm:gap-4">
                  {emails.map((addr, i) => (
                    <div key={`${addr}-${i}`} className="flex items-center gap-3 sm:gap-4">
                      <span
                        className="border border-(--color-primary-blue) p-2 rounded-full shrink-0"
                        aria-hidden
                      >
